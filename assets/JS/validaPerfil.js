function validaPerfil() {
    ...
    if (tipoUsuario === 'prestador') {
        ...
        document.getElementById('nome-social-field').style.display = 'none';
        document.getElementById('nome-social-div').style.display = 'none';
    }
}

function habilitarCampos() {
    const campos = document.querySelectorAll('#editForm input, #editForm select, #editForm textarea');
