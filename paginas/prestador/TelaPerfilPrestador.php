        ...
        <div class="row d-flex flex-wrap">
            ...
            <div class="col-md-4 mt-2">
                ...
                <div class="text-center botao-altera-foto">
                    <button type="button" class="btn btn-primary mb-2 mt-2" id="alterar-foto"
                    ...
                    <a href="../../paginas/prestador/TelaMeusProdutos.php" class="btn btn-primary mb-2 mt-2" id="meus-dados"
                        style="background-color: #012640; color:white" data-bs-toggle="modal">
                        <i class="bi bi-gear"></i> Mais detalhes
                    </a>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="formFotoPerfil">
                                    <div class="mb-3">
                                        <label for="inputFotoPerfil" class="form-label">Escolha uma nova foto de
                                            perfil</label>
                                        <input class="form-control" type="file" id="inputFotoPerfil" accept="image/*">
                                    </div>
                                    <div class="text-center">
                                        <img id="previewFotoPerfil" src="#" alt="Prévia da Foto" class="img-thumbnail"
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary"
                                    style="background-color: #012640; color:white" id="salvarFoto">Salvar</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-8 mt-2">
                <h3 class="text-left">Editar Perfil<button class="btn btn-admin edit-perfil" id="editarPerfil"><i
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                ...
                <button type="button" class="btn btn-primary btnAlteraSenha mb-2" data-bs-toggle="modal"
                    id="AlteraSenha" data-bs-target="#mdlAlteraSenha"
                    style="background-color: #012640; color:white;">Alterar Senha</button>

                <button type="submit" class="btn btn-primary mb-2"
                    style="background-color: #012640; color:white">Salvar</button>
            </div>

            <div class="modal fade" id="mdlAlteraSenha" tabindex="-1" aria-labelledby="mdlAlteraSenhaLabel"
                aria-hidden="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control" id="senhaAtual"
                                            style="background-color: white; border: 1px solid #1A3C53; border-radius: 5px;">
                                        <button type="button" class="btn" id="toggleSenhaAtual"
                                            style="color: #1A3C53; ">
