    ...
    private function content() {
        ...
        <div class="container-fluid contLogin mt-5">
            <div class="card col-md-4 cardLogin" style="border-radius: 8px">
                ...
                <input type="text" class="form-control form-control-sm my-2" style="border-radius: 8px" placeholder="Usuário">
                <input type="password" class="form-control form-control-sm my-2" style="border-radius: 8px" placeholder="Senha">

                <button type="submit" id="entrarBtn" class="btn btn-primary btn-sm w-100 my-2" style="color: white; border: none; background-color: #1A3C53; border-radius: 8px">Entrar</button>
