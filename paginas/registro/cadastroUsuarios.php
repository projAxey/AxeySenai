    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            <form id="iCadastroUsuarios" method="POST" action="../../backend/register.php">
              ...
              <div id="nomeSocialFields" class="d-none mb-3">
                ...
                <input type="text" class="form-control" id="nomeSocial" name="nomeSocial" placeholder="Ex: Joãozinho" required>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-5" id="dataNascimentoFields">
                  ...
                  <input type="date" class="form-control text-center" id="dataNascimento" name="dataNascimento" required>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6 d-none" id="categoriaFields">
                  ...
                  <select class="form-select" id="seguimento" name="seguimento" required>
              ...
              <div id="descricaoFields" class="d-none">
                <div class="mb-3">
                  ...
                  <textarea class="form-control descricaoNegocio" id="descricao" name="descricao" required></textarea>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <div class="d-flex">
                    <input type="text" class="form-control me-2" id="cep" name="cep" placeholder="00000-000" maxlength="9" required>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-3">
                  ...
                  <input type="number" class="form-control numero-menor" id="iNumero" name="numero" maxlength="8" min="0" step="1" oninput="this.value = this.value.slice(0, 8)" required>
                </div>
              </div>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <button class="btn btn-outline" type="button" id="toggleSenha" name="senha">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <button class="btn btn-outline" type="button" id="toggleSenhaRepetida">
