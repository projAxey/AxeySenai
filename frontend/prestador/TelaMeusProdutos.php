...
<div class="list-group-item d-flex justify-content-between align-items-center">
    ...
    <div>
        <button class="btn btn-sm btn-admin edit-admin" data-bs-toggle="modal" data-bs-target="#editModal" onclick="editService(' . $produto['produto_id'] . ', \'' . htmlspecialchars($produto['nome_produto']) . '\', \'' . htmlspecialchars($produto['titulo_categoria']) . '\')">
        ...
        <button class="btn btn-sm btn-admin view-admin" data-bs-toggle="modal" data-bs-target="#viewModal"
            onclick="viewService(\'' . htmlspecialchars($produto['nome_produto']) . '\', \'' . htmlspecialchars($produto['titulo_categoria']) . '\')">
...
<script>
function editService(produtoId, nomeProduto, tituloCategoria) {
    document.getElementById('edit-service-id').value = produtoId;
    document.getElementById('edit-service-title').value = nomeProduto;
    document.getElementById('edit-service-category').value = tituloCategoria;
}

function viewService(nomeProduto, tituloCategoria) {
