...
<body>
    ...
    <div class="container-fluid contLogin mt-5">
        ...
        <div class="card col-md-4 cardLogin" style="border-radius: 8px">
            <button type="button" class="mb-2 btn btn-primary btn-novo-link"
                style="background-color: #012640; color:white" onclick="window.location.href='../../index.php'"><i
            ...
            <form style="width: 80%;" method="POST" action="../../backend/auth/login.php">
                <input type="text" name="email" class="form-control my-2" style="border-radius: 8px"
                    placeholder="Usuário" required>
                <div class="input-group" style="position: relative;">
                    <input type="password" id="password" name="password" class="form-control my-2"
                        style="border-radius: 8px; width: 100%;" placeholder="Senha" required>

                    <button type="button" class="btn" id="toggleSenha"
                        style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); border: none; background: none; color: #1A3C53;">
                        <i class="bi bi-eye-slash" id="iconSenha"></i>
                    </button>
                </div>

                <button type="submit" class="btn btn-primary w-100 my-2"
                    style="color: white; border: none; background-color: #1A3C53; border-radius: 8px">Entrar</button>
            </form>
            <a href="#" class="btnEsqueciSenha btn-sm" data-bs-toggle="modal" data-bs-target="#esqueciSenhaModal"
                style="color: #00376B;">Esqueci minha senha</a>
