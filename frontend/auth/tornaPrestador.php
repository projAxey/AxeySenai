...
<!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA -->
 <!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA -->
  <!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA -->
   <!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA -->
    <!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA --><!-- ESTA TELA SERA IMPLEMENTADA COMO MELHORIA FUTURA -->
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center">
                        ...
                        <h3>Atualize sua conta. É grátis!</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" class="form-control" id="endereco" name="endereco"
                                        value="<?= htmlspecialchars($cliente['logradouro'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="estado" name="estado"
                                        value="<?= htmlspecialchars($cliente['uf'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                </div>
                                <div class="col-md-4">
