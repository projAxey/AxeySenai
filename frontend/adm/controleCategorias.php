            ...
            <div class="container">
                <div class="container">
                    ...
                    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center mb-4">
                        ...
                        <button type="button" id="meusAgendamentos"
                            class="btn btn-meus-agendamentos w-20 w-lg-auto mb-3 mb-lg-0"
                        ...
                        <form method="GET" action="controleCategorias.php" class="d-flex flex-grow-1 justify-content-center mt-2 mt-lg-0 mx-lg-3">
                        ...
                        <form method="GET" action="controleCategorias.php" class="d-flex mt-2 mt-lg-0">
                            ...
                            <button type="submit" class="btn btn-primary" style="background-color: #012640; color: white;">Filtrar</button>
                        </form>
                    </div>
                </div>
