...
<body>
   ...
   <div id="usarNomeSocialField" class="form-check mb-3">
      <input class="form-check-input" type="checkbox" id="usarNomeSocial" name="usarNomeSocial">
   ...
   <div class="row mb-3">
      ...
      <div class="col-md-6 d-none" id="categoriaFields">
         ...
         <select class="form-select" id="seguimento" name="seguimento">
   ...
   <script>
    ...
    function toggleFields(type) {
        // Oculta ou exibe os campos com base no tipo
